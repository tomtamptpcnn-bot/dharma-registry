...
ที่อยู่เลือกจังหวัด → อำเภอ/เขต → ตำบล/แขวง และเติมรหัสไปรษณีย์อัตโนมัติ บ้านเลขที่/หมู่บ้าน/ถนนกรอกเอง ที่อยู่เก่าเก็บไว้ในช่องรายละเอียดโดยไม่เดาจังหวัดให้ ข้อมูลตัวเลือกแนบอยู่ในโปรแกรม ไม่ต้องเรียกบริการภายนอกเมื่อกรอกที่อยู่ แหล่งข้อมูลและใบอนุญาตอยู่ใน `lib/data/`.
